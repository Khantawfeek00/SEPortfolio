                ...
                <div className="contact__grid">
                    ...
                    <div className="contact__info fade-in-left">
                        ...
                        <div className="contact__channels">
                            <a href="mailto:khantawfeek00@gmail.com" className="contact__channel neo-card">
                            ...
                            <a href="tel:+919673500285" className="contact__channel neo-card">
                                <div className="contact__channel-icon">
                            ...
                            <a href="https://linkedin.com/in/tawfeek-khan" target="_blank" rel="noopener noreferrer" className="contact__channel neo-card">
                            ...
                            <a href="https://github.com/Khantawfeek00" target="_blank" rel="noopener noreferrer" className="contact__channel neo-card">
                                <div className="contact__channel-icon">
                    ...
                    {/* Contact Form */}
                    <form className="contact__form neo-card fade-in-right" ref={formRef} onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="neo-btn contact__submit" disabled={sending}>
